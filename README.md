...
This example requires Kafka and Spark on HDInsight 3.6 in the same Azure Virtual Network. It also requires an Azure Cosmos DB SQL API database. This project includes a template that can be used to create these resources on your Azure subscription. To use the template, select the __Deploy to Azure__ button.
